...
private void salir(){
 ...
 public void agregarInciden(Incidente incidente){//va a recibir un estudiante
...
private void buscar(String criterio){
 ...
 public void actualizarInciden(Incidente incidente) {
...
public void agregarNuevoIncidente(Incidente incidente) {
    ...
    private void initComponents() {
        ...
        btnDownload.setText("Guardar en TXT");
        btnDownload.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDownloadActionPerformed(evt);
            }
        });
        jPanel1.add(btnDownload, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 290, -1, -1));
    ...
    if (returnValue == JFileChooser.APPROVE_OPTION) {
        try {
            ...
            for (Incidente incidente : incidentes) {
                writer.write("Tipo: " + incidente.getTipo() + " - Hora: " + incidente.getHora() + " - Fecha: " + incidente.getFecha() + "\n");
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Incident data saved successfully.");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
